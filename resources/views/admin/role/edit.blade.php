...
@section('content')
 ...
 <div class="content-wrapper">
  ...
  @include('partial.content_header',['name'=>'Roles','key'=>'Edit'])
          ...
          <div class=col-md-12>
            @csrf
              ...
              <div class="form-group">
                ...
                <input value="{{$role->name}}" class="form-control" name="name"   placeholder="mời nhâp tên cho slider">
                      ...
                      <div class="row">
                        ...
                        <div class="card-body text-primary">
                          <h5 class="card-title">
                            ...
                            <input 
                            type="checkbox"
                            class="checkbox_childrent" name="permission_id[]"
                            {{$permissionsChecked->contains('id',$permissionsChildrentItem->id)? 'checked':''}}

                             value="{{$permissionsChildrentItem->id}}"   ></label>
